		...
		<div class="container">
		  ...
		  <div class="nav-collapse">
			<ul class="nav">
			  ...
			  <li class=""><a href="<c:url value='list-view.html'/>">Sản phẩm</a></li>
			  <li class=""><a href="grid-view.html">Giỏ hàng</a></li>
			  <li class=""><a href="<c:url value='/list-order' />">Đơn hàng</a></li>
			  <li class=""><a href="<c:url value='/products-bought'/>">Hàng đã mua</a></li>
